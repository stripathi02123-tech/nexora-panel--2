      ...
      <div className="flex items-center justify-between h-14 px-4 border-b border-gray-200 dark:border-gray-700">
        {!collapsed && (
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-black text-sm dark:text-white">Nexora Panel</span>
          </div>
        )}
        {collapsed && (
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 p-2 space-y-1">
        ...
        {version && (
          <div className={`px-3 py-2 text-xs text-gray-400 dark:text-gray-500 ${collapsed ? 'text-center' : ''}`}>
            {collapsed ? (
              <a
                href="https://github.com/stripathi02123-tech/nexora-panel--2"
                target="_blank"
                rel="noreferrer"
                title={`Nexora Panel v${version}`}
              ...
              <div className="flex min-w-0 items-center gap-2">
                ...
                >
                  ...
                  <span className="truncate">Nexora Panel</span>
                </a>
